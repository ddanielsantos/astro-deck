...
const Button = (props: ButtonProps) => {
    ...
    const directionBasedProps = props.direction === 'prev' ? {left: '0'} : {right: '0'}
    ...
    return (
        <a id={props.id} href={props.href} style={{
            ...
            ...directionBasedProps,
            ...debugProps,
        }}>{props.children || props.direction}</a>
    )
}
...
export const SlideControls = ({hasNext, hasPrev, nextSlideUrl, prevSlideUrl}: Props) => {
    return (
        <>
